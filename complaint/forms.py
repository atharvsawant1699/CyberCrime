...
class ComplaintForm(forms.ModelForm):
    class Meta:
        model = Complaint
        fields = ['name', 'email', 'phone', 'title', 'category', 'description', 'location', 'evidence']
        widgets = {
            ...
            'category': forms.Select(attrs={'class': 'w-full bg-surface border border-outline rounded-lg px-4 py-3 focus:ring-4 focus:ring-primary/20 focus:border-primary transition-all outline-none appearance-none', 'id': 'id_crime_category'}),
